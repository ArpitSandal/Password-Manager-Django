...
function allcategory() {
    ...
    let to_show_or_notshow = [document.getElementById('passshow'), document.getElementById('creditshow'), document.getElementById('notesshow')];
...
function not_show_func(showthisid, id1, id2) {
    let to_show_or_notshow = [document.getElementById(id1), document.getElementById(id2)];
...
function showcreatenew(){
    ...
    for(let i=0; i<elm.length; i++){
        if(elm[i].className == "notshowcat")
            elm[i].className+=" notshow";
